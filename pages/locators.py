...
create_recruit_req_view_profile = (By.ID, 'cc_recruitment_request_cc_profile_create_button')
name_create_recruit_req_view_profile = (By.ID, 'name')
save_btn_create_recruit_req_view_profile = (By.ID, "CC_Recruitment_Request_subpanel_save_button")
select_recruit_req_view_profile = (By.ID, 'cc_recruitment_request_cc_profile_select_button')
