...
def test_SCRM_356_personality(browser):
...
#SELECT A PERSONALITY TEST
    ...
    webdriver.click_button(page_object.personality_test_view_candidate)

    # Click on the Select to open the new window.
    webdriver.click_button(page_object.select_personality_view_candidate)
    ...
    webdriver.click_button(page_object.option_select_personality_view_candidate)
...
#CREATE A PERSONALITY TEST
    ...
    webdriver.click_button(page_object.create_personality_view_candidate)
    
    # Send keys to the name input.
    webdriver.send_keys_to_element(page_object.score_index__create_on_view_candidate, '55')

    # Click on the save button to create the request on the subpanel.
    webdriver.click_button(page_object.save_button_personality_view_candidate)